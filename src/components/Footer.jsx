...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://linkedin.com/in/abhinavbahadursingh", label: "LinkedIn" },
    { icon: <Github size={18} />, href: "https://github.com/abhinavbahadursingh", label: "GitHub" },
    { icon: <Mail size={18} />, href: "mailto:abhinavbahadursingh69@gmail.com", label: "Email" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "abhinavbahadursingh69@gmail.com", href: "mailto:abhinavbahadursingh69@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 9555711500", href: "tel:+919555711500" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">ABHINAV BAHADUR SINGH</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                AI/ML & Computer Vision Engineer architecting intelligent solutions.
              </p>
            ...
            {/* Newsletter */}
            <motion.div variants={itemVariants} className="space-y-4">
              <h4 className="text-gray-900 dark:text-white font-medium text-sm uppercase tracking-wider">Connect</h4>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Interested in collaborations or hiring for AI/ML & Full-Stack roles? Let's connect!
              </p>
              <a 
                href="mailto:abhinavbahadursingh69@gmail.com"
                className="inline-block bg-primary hover:bg-primary/90 text-white dark:text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-300 text-center w-full"
              >
                Send an Email
              </a>
            </motion.div>
          ...
          >
            <div>
              <p>© {currentYear} Abhinav Bahadur Singh. All rights reserved.</p>
            </div>
